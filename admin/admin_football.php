...
<body>
	...
	<div id="leftnav">
		<ul>
			<li><a href="admin_home.php" style="color:#333;">Điều khiển</a></li>
			...
			<li><a href="message.php">Thông báo</a></li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					<?php
					echo "<a href='stockin.php?id=".$id."' class='btn btn-success' rel='facebox'><i class='icon-plus-sign icon-white'></i> Còn hàng</a> ";
					echo "<a href='stockout.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-minus-sign icon-white'></i> Hết hàng</a>";
					?>
					</td>
				</tr>
				<?php
