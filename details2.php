...
<div id="container">
	<div class="nav">
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> Tôi đồng ý <a href="#terms" data-toggle="modal">Điều khoản và điều kiện </a> của My Shoes.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Điều khoản và điều kiện của My Shoes</h3>
			</div>
				<div class="modal-body">
					<ul>
					    <li>Bạn được đảm bảo rằng sản phẩm của bạn sẽ được giao sau 2-3 ngày kể từ ngày đặt hàng.</li>
						<li>Thời gian đảm bảo có thể tạm dừng tùy thuộc vào điều kiện thời tiết để đảm bảo an toàn cho nhân viên giao hàng của chúng tôi.</li>
						<li>Tất cả giá được niêm yết bằng đồng peso . Thông tin về giá cả và tình trạng còn hàng có thể thay đổi mà không cần báo trước.</li>
						<li>Phương thức thanh toán như sau: khách hàng có tài khoản paypal có thể thanh toán qua paypal, nếu không sẽ chuyển tiền khi nhận hàng (COD).</li>
						<li>Khi nhận được sản phẩm của bạn, chúng tôi sẽ tính phí giao hàng chỉ 150 peso tùy địa điểm.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
